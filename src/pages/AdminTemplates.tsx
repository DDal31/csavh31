...
export default function AdminTemplates() {
  ...
  const { loading, error, templates, selectedTemplate, handleTemplateChange } = useTemplates();

  console.log("AdminTemplates rendering, loading:", loading, "templates:", templates, "error:", error);
